...
const formatArray = (arr) => {
  return `The array has ${arr.length} items. first is "${arr[0]}" second is "${
    arr[arr.length - 1]
  }"`;
};
...
console.log(printSecondCharacter([1, 5, 3, 5, 8]));
// 40
...
console.log(sumOfEvenIndices([2, 1, 2, 1])); // 6
...
const getAddress = ({ name, postalCode, city }) => {
  const newUserData = {
