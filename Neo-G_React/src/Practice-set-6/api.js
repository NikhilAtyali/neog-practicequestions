export const fakeFetch1 = (url) => {
 ...
 export const todoapi = (url) => {
  ...
  export const userProfileApi = (url) => {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
